...
import br.com.bandtec.agendadeobjetivos.domain.Prioridade;
import br.com.bandtec.agendadeobjetivos.domain.ResumoDoObjetivo;
...
public class ObjetivoServiceTest {
	...
	public void associarUmUsuarioAUmObjetivo() {
		...
		Objetivo objetivo = new Objetivo(new ResumoDoObjetivo("titulo", "descricao"), now(), 
